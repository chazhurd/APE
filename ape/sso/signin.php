...
/* CHAZ(foraddedsecurity?)
<<?php
define('__ROOT__', dirname(dirname(__FILE__)));
require_once(__ROOT__.'/config.php'); 
?>*/ 
//Removed and replaced by CHAZ HURD $cas_server_ca_cert_path = 'comodo_combo.pem';
$cas_real_hosts = array('it-adfs01.eastern.ewu.edu',
                        'it-casauth01.eastern.ewu.edu');
  /* CAS Protocol Configuration (ADDED BY CHAZ HURD)*/
  $cas_host = "sso.ewu.edu";
  $cas_port = 443;
  $cas_context = "/idp/profile/cas";
  $cas_server_ca_cert_path = "./STAR_ewu.edu.ca";
